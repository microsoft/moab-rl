...
from sim.model import MoabModel, clamp
...
class MoabSim(Env):
    ...
    def reset(self, *, seed=None, options=None):
        ...
        # Optional config parameters for domain randomization
        PingPongRadius = 0.02
        PingPongShell = 0.0002
        config = {
            "ball_radius": np.random.uniform(
                low=PingPongRadius * 0.8, high=PingPongRadius * 1.2
            ),
